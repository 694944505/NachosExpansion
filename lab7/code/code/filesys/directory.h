...
//#define FileNameMaxLen 10
//* NumDirEntries) / sizeof(char)) - 1)
...
{
public:
  Directory(int size, int current=DirectorySector, int parent=DirectorySector); // Initialize an empty directory
