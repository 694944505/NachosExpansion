...
Directory::Directory(int size,int current/*=DirectorySector*/, int parent/*=DirectorySector*/)
{
    ...
    //printf("%d %d %d\n",size,sizeof(DirectoryEntry),FileNameMaxLen);
}
...
bool Directory::Add(char *name, int newSector, bool isDirec /*=0*/)
{
    if (FindIndex(name) != -1)
        return FALSE;
